r"""
Module containing the `~halotools.mock_observables.transverse_pvd_vs_r` function
used to calculate the pairwise transverse velocity dispersion
...
from .engines import transverse_pvd_vs_r_engine
...
__all__ = ('transverse_pvd_vs_r', )
__author__ = ('Andrew Hearin', 'Duncan Campbell')


def transverse_pvd_vs_r(sample1, velocities1,
        rbins_absolute=None, rbins_normalized=None, normalize_rbins_by=None,
        sample2=None, velocities2=None, period=None,
        num_threads=1, approx_cell1_size=None, approx_cell2_size=None):
    r"""
    Calculate the pairwise transverse velocity dispersion as a function of absolute distance,
    ...
    sigma_12 : numpy.array
        ...
        of the pairwise transverse velocity, :math:`\sigma_{12}(r)`,
    ...
    engine = partial(transverse_pvd_vs_r_engine, double_mesh,
